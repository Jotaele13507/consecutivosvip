        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <h1 class="heading-section">Dirección Administrativa<br /><small style="font-size:20px">Registro de Circulares</small></h1>
                </div>
            </div>
            <div class="row justify-content-center">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" name="n_circular" placeholder="Número de Circular">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
